...
def diseasepred(request):
    ...
    try:
        ...
        elif params['nbpd'][0] in ENT_specialist:
            consultdoctor = "ENT specialist"

        elif params['nbpd'][0] in Orthopedist:
            consultdoctor = "Orthopedist"

        elif params['nbpd'][0] in Neurologist:
            consultdoctor = "Neurologist"

        elif params['nbpd'][0] in Allergist_Immunologist:
            consultdoctor = "Allergist_Immunologist"

        elif params['nbpd'][0] in Urologist:
            consultdoctor = "Urologist"

        elif params['nbpd'][0] in Dermatologist:
            consultdoctor = "Dermatologist"

        elif params['nbpd'][0] in Gastroenterologist:
